...
from devflow.legacy.control_room.scheduler_projection import build_scheduler_snapshot
from devflow.legacy.control_room.status_projection import list_task_status_projections
from devflow.legacy.control_room.supervisor_policy import (  # noqa: F401
...
from devflow.legacy.control_room import supervisor_task_review as _tr
...
def build_control_room_status(root: Path, *, live_discovery: bool = True) -> dict[str, Any]:
    ...
    from devflow.legacy.control_room.operator_readiness import build_operator_readiness_snapshot
