...
from devflow.legacy.control_room.goal_tasks import load_goal_task_slices
from devflow.legacy.control_room.knowledge_foundry import capture_from_validation, search_knowledge
from devflow.legacy.control_room.idea_execution_bridge import create_goal_from_idea
from devflow.legacy.control_room.idea_foundry import capture_idea, classify_idea, promote_idea
from devflow.legacy.control_room.intent_scaffold import preview_scaffold_from_idea, write_scaffold_from_idea
from devflow.legacy.control_room.local_agent_discovery import LocalDiscoveryReport, parse_ollama_list
from devflow.legacy.control_room.local_model_worker_pool import agent_json_payload, registry_json_payload
from devflow.legacy.control_room.local_worker_lane import local_worker_lane_summary
from devflow.legacy.control_room.model_audition import execute_model_audition, write_model_audition_dry_run_plan
...
from devflow.legacy.control_room.orchestration_plan import create_orchestration_plan
...
from devflow.legacy.control_room.patch_dry_run import preview_patch_dry_run
from devflow.legacy.control_room.patch_review import normalize_agent_patch_candidate, review_patch_candidate
from devflow.legacy.control_room.readiness import promotion_readiness_errors
...
from devflow.legacy.control_room.supervisor_surface import build_control_room_status
from devflow.legacy.control_room.task_closure import close_task
from devflow.legacy.control_room.task_packet import TaskPacketLimits, build_agent_packet, build_task_packet
from devflow.legacy.control_room.worker_evidence import write_worker_evidence
from devflow.legacy.control_room.worker_outcome import validate_worker_outcome
...
from devflow.legacy.control_room.dogfood_case_scratch import (
...
from devflow.legacy.control_room.dogfood_case_result import (
...
from devflow.legacy.control_room.dogfood_cases_operational import (
    _case_operator_readiness_reconciliation,
    _case_question_blocker_resume_loop,
    _case_simple_scheduler_parallel_coordination,
    _commands_have_no_provider_calls,
)
from devflow.legacy.control_room.dogfood_run_store import (
    load_dogfood_run,
    new_dogfood_run_id,
