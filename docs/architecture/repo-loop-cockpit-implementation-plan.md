...
| RLC-02 | done | Pipeline run projection in operating snapshot | `operating_layer.py`, `operating_layer_first_viewport.py`, `pipeline_run.py` | RLC-01 | `local_test_runner.py --pytest "tests/test_pipeline_run.py tests/test_operating_layer.py" --ruff "src/devflow/control_room/operating_layer.py src/devflow/control_room/operating_layer_first_viewport.py"` PASS: 64 passed, ruff clean; evidence `.devflow/evidence/test-results-rlc-02.json`; verify receipt `.devflow/evidence/verify-rlc-02.json` |
| RLC-03 | done | Narrow curated handoff intake | `obsidian_task_bridge.py`, `operating_layer_obsidian_handlers.py`, `operating_layer_server.py`, `tests/test_obsidian_task_bridge.py` | RLC-02 | PASS: 71 passed, ruff clean; evidence `.devflow/evidence/test-results-rlc-03.json`; verify receipt `.devflow/evidence/verify-rlc-03.json` |
| RLC-04 | done | Brainstorm-to-classification gate | `brainstorm_pipeline.py`, `operating_layer_brainstorm_handlers.py`, `operating_layer_brainstorm_routes.py`, `operating_layer_server.py`, `tests/test_brainstorm_classification.py` | RLC-03 | 31 classification tests + 33 existing = 64 passed, ruff clean; rule-based classifier with work_type/rationale/deterministic-tool-eligibility/presets |
| RLC-05 | done | Supervisor intent summary artifact | `pipeline_run.py` (IntentSummary model), `brainstorm_pipeline.py` (rule-based generation + persistence), `operating_layer_brainstorm_routes.py` (payload builder), `operating_layer_brainstorm_handlers.py` (handler), `operating_layer_server.py` (POST /api/brainstorm/intent-summary), new `tests/test_intent_summary.py` | RLC-04 | 36 intent summary tests + 31 classification + 33 existing = 100 passed, ruff clean; rule-based keyword/pattern heuristics; manual_summary override; `intent-summary.json` in MINIMUM_RUN_FILES |
...
Start RLC-06 by adding a Builder-Judge readiness packet builder. Validate required readiness fields (objective, repo, file targets, dependencies, verification commands, stop conditions, intent summary) before Builder-Judge launch. If fields are missing, route to Spec/Planning instead. Files: new `pipeline_readiness.py`, `brainstorm_task_bridge.py`, focused packet tests.
