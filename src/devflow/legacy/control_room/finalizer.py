...
from devflow.legacy.control_room.paths import absolute_path, task_dir
from devflow.legacy.control_room.persistence import get_task, utc_now, atomic_write_text, save_task
        ...
        if head_proc.returncode == 0:
            ...
            if verification_json_path.exists():
                try:
                    ...
                    pass
            from devflow.legacy.control_room.task_lifecycle import write_merge_readiness
