...
def idea_capture(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, capture_idea
...
def idea_list(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, list_ideas, render_idea_list
...
def idea_show(idea_id: str) -> None:
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, render_idea_show, show_idea
...
def idea_classify(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, classify_idea
...
def idea_promote(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, promote_idea
...
def idea_create_goal(
    ...
    try:
        from devflow.legacy.control_room.idea_execution_bridge import (
...
def idea_scaffold_goal(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError
        from devflow.legacy.control_room.intent_scaffold import (
...
def idea_park(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, park_idea
...
def idea_archive(
    ...
    try:
        from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, archive_idea
