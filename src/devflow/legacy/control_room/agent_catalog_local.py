...
from devflow.legacy.control_room.agent_catalog_hermes import (
...
from devflow.legacy.control_room.local_agent_discovery import LocalDiscoveryReport, discover_local_ollama_models
from devflow.legacy.control_room.machine_capability import (
    MachineCapability,
    classify_model_fit,
