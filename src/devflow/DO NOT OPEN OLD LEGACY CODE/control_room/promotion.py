...
from devflow.legacy.control_room.readiness import format_promotion_refusal, human_promotion_gate, promotion_readiness_errors
from devflow.legacy.control_room.git_worktree import build_git_promotion_preview, is_git_worktree_task, promote_git_worktree
...
def _get_relative_files(base_dir: Path, repo_root: Path | None = None) -> set[str]:
    ...
    if repo_root is not None and rel_files:
        from devflow.legacy.control_room.git_state import git_ignored_paths
