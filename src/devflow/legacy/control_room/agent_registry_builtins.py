...
from devflow.legacy.control_room.agent_registry import AgentDefinition, adapter_maturity
...
def builtin_agents() -> dict[str, AgentDefinition]:
    ...
    # ── Multi-model subagent routing profiles ──────────────────────────
    # OpenAI Codex lane (primary)
    _mm_profiles = [
        {
            "id": "gpt-scout",
            "model": "gpt-5.4-mini",
            "provider": "openai-codex",
            "adapter": "hermes_profile",
            "role": "read_only_scout",
            "tier": "frontier_remote",
            "model_role_name": "gpt-5.4-mini",
            "weight_class": "small",
            "secondary_roles": ["file-analysis", "spec-review", "documentation"],
            "purpose": "Read-only file scouting and analysis via GPT-5.4 Mini. Fast, cheap, vision-capable.",
            "use_caution": ["Read-only; do not write or mutate files."],
            "hermes_delegable": True,
            "reliable_context_tokens": 1048576,
            "vision": True,
            "thinking": False,
            "code_focus": "frontier_general",
            "speed_class": "fast",
            ...
            "tool_access": ["devflow-context"],
            "tuned_for_archetypes": ["trivial_edit", "code_review", "documentation", "ui_visual_review"],
        },
        {
            "id": "gpt-vision",
            "model": "gpt-5.4",
            ...
            "role": "vision_scout",
            "tier": "frontier_remote",
            "model_role_name": "gpt-5.4",
            "weight_class": "medium",
            "secondary_roles": ["screenshot-review", "ui-analysis", "diagram-inspection"],
            "purpose": "Vision scout via GPT-5.4. Screenshot review, UI analysis, diagram inspection.",
            "use_caution": ["Read-only; do not write or mutate files."],
            "hermes_delegable": True,
            "reliable_context_tokens": 1048576,
            "vision": True,
            ...
            "input_modalities": ["text", "image"],
            "tool_access": ["devflow-context"],
            "tuned_for_archetypes": ["ui_visual_review", "context_synthesis"],
        },
        # OpenRouter fallback lane
        {
            ...
            "role": "implementation_worker",
            "tier": "remote",
            "model_role_name": "deepseek-v4-flash",
            "weight_class": "medium",
            "secondary_roles": ["code-reviewer", "fallback-coder"],
            "purpose": "Fallback coding subagent via DeepSeek V4 Flash on OpenRouter. Used when OpenAI session limits are hit.",
            "use_caution": ["Advisory evidence only; keep verification under Dev-Flow gates."],
            "hermes_delegable": True,
            "reliable_context_tokens": 943718,
            "vision": False,
            "thinking": False,
            "code_focus": "frontier_general",
            "speed_class": "fast",
            ...
            "input_modalities": ["text"],
            "tool_access": ["devflow-context"],
            "tuned_for_archetypes": ["simple_implementation", "complex_implementation", "code_review"],
        },
        {
            "id": "or-scout",
            "model": "deepseek/deepseek-v4-flash",
            ...
            "weight_class": "small",
            "secondary_roles": ["file-analysis", "spec-review", "documentation"],
            "purpose": "Fallback read-only scout via DeepSeek V4 Flash on OpenRouter.",
            "use_caution": ["Read-only; do not write or mutate files."],
            "hermes_delegable": True,
            "reliable_context_tokens": 943718,
            "vision": False,
        ...
        },
        {
            ...
            "role": "vision_scout",
            "tier": "remote",
            "model_role_name": "minimax-m3",
            "weight_class": "medium",
            "secondary_roles": ["screenshot-review", "ui-analysis"],
            "purpose": "Fallback vision scout via MiniMax M3 on OpenRouter. Has image and video input.",
            "use_caution": ["Read-only; do not write or mutate files."],
            "hermes_delegable": True,
            "reliable_context_tokens": 943718,
            "vision": True,
        ...
        },
        {
            ...
            "role": "frontier_planner_architect_reviewer",
            "tier": "remote",
            "model_role_name": "glm-5.2",
            "weight_class": "medium",
            "secondary_roles": ["planning", "architecture-review", "fallback-supervisor"],
            "purpose": "Fallback supervisor via GLM 5.2 on OpenRouter. Replaces GPT-5.5 when all OpenAI session limits are hit.",
            "use_caution": ["Advisory evidence only; do not create tasks, run workers, apply patches, verify, promote, commit, or push."],
            "hermes_delegable": False,
            "reliable_context_tokens": 1048576,
            "vision": False,
            "thinking": True,
            ...
            "input_modalities": ["text"],
            "tool_access": ["devflow-context"],
            "tuned_for_archetypes": ["brainstorm", "planning", "architecture_design", "context_synthesis"],
        },
    ]

    for profile in _mm_profiles:
        agent_id = str(profile["id"])
        agents[agent_id] = AgentDefinition(
            id=agent_id,
            ...
            adapter_maturity=adapter_maturity(str(profile["adapter"])),
            role=str(profile["role"]),
            tier=str(profile["tier"]),
            default_mode="read_only",
            execution_mode="automated",
            ...
            use_caution=list(profile["use_caution"]),
            required_verification_command=None,
            manifest_notes=["Session limits may apply for OpenAI Codex profiles."],
            workspace="isolated_task_workspace",
            can_see=[
                "supervisor_packet",
                "task_packet",
            ...
            required_outputs=[
                "Record advisory output, model identity, and provider metadata under agent evidence.",
                "Treat all recommendations as evidence only; Dev-Flow and the human operator own task creation, verification, and promotion.",
            ],
            completion_rules=[
                "Use bounded Dev-Flow state only; do not scan the full repository blindly.",
                "Do not create tasks, run workers, apply patches, verify, promote, commit, push, or mutate canonical state.",
