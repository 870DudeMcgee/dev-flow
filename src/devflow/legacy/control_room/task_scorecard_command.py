...
from devflow.legacy.control_room.scorecard import generate_scorecard, save_scorecard
...
def _update_runtime_profile_from_scorecard(root: Path, scorecard_data: dict[str, Any]) -> None:
    try:
        from devflow.legacy.control_room.model_runtime_profiles import update_from_scorecard
