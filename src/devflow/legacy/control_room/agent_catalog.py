...
from devflow.legacy.control_room.agent_catalog_local import (
    _local_model_policy,
...
from devflow.legacy.control_room.machine_capability import discover_machine_capability
from devflow.legacy.control_room.local_agent_discovery import LocalDiscoveryReport
