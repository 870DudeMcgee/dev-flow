...
from devflow.legacy.control_room.machine_capability import MachineCapability, discover_machine_capability
...
def _managed_start_profile(lane: ExpectedLocalModelLane) -> str | None:
    try:
        from devflow.legacy.control_room.local_model_server import known_local_model_server_profiles
