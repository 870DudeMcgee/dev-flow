...
from devflow.legacy.control_room.agent_runtime import resolve_agent_runtime_definition, runtime_contract_payload
...
def build_agent_catalog(root: Path, *, provider_id: str | None = None) -> dict[str, Any]:
    from devflow.legacy.control_room.agent_catalog import build_agent_catalog as _build_agent_catalog

    return _build_agent_catalog(root, provider_id=provider_id)


def configured_hermes_agents() -> list[dict[str, Any]]:
    from devflow.legacy.control_room.agent_catalog import configured_hermes_agents as _configured_hermes_agents

    return _configured_hermes_agents()
...
def _ollama_enrichment(model_id: str) -> dict[str, Any]:
    try:
        from devflow.legacy.control_room.local_agent_discovery import _run_ollama
