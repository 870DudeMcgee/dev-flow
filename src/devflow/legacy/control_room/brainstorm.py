...
from devflow.legacy.control_room.agent_registry import (
    AgentDefinition,
    ProviderDefinition,
...
from devflow.legacy.control_room.env_loader import resolve_api_key
from devflow.legacy.control_room.hermes_profile_resolver import (
    hermes_direct_handoff_state,
    load_hermes_picker_runtime,
)
from devflow.legacy.control_room.local_model_server import ensure_local_model_server_for_profile
...
from devflow.legacy.control_room.paths import ideas_dir, relative_path
from devflow.legacy.control_room.persistence import atomic_write_text
from devflow.legacy.control_room.stage_artifact import write_stage_artifact as save_stage_artifact
...
def start_brainstorm_from_idea(
    ...
    """
    root = root.resolve()
    from devflow.legacy.control_room.idea_foundry import IdeaFoundryError, _get_idea, _read_optional_text
...
def _record_idea_brainstorm_link(root: Path, metadata: dict[str, Any], session_id: str) -> None:
    ...
    from devflow.legacy.control_room.idea_foundry import _write_idea
