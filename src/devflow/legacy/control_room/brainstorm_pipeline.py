...
from devflow.legacy.control_room.persistence import append_event, atomic_write_text
...
def build_manual_intent_summary(
    ...
    """
    from devflow.legacy.control_room.pipeline_run import IntentSummary
...
def write_intent_summary_to_run(
    ...
    """
    from devflow.legacy.control_room.pipeline_run import _run_dir, update_pipeline_run_record
