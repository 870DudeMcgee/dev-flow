...
from devflow.legacy.control_room.shell_worker import ShellWorkerAdapter
from devflow.legacy.control_room.manual_worker import ManualWorkerAdapter
from devflow.legacy.control_room.ollama_worker import OllamaChatWorkerAdapter
from devflow.legacy.control_room.openai_compatible_worker import OpenAICompatibleWorkerAdapter
from devflow.legacy.control_room.anthropic_worker import AnthropicMessagesWorkerAdapter
from devflow.legacy.control_room.gemini_worker import GeminiWorkerAdapter
from devflow.legacy.control_room.openai_chat_worker import OpenAIChatWorkerAdapter
