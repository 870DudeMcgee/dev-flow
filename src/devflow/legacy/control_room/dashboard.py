...
from devflow.legacy.control_room.operator_readiness import OperatorReadinessSnapshot, build_operator_readiness_snapshot
...
def collect_multi_project_dashboard_state(*, include_archived: bool = False) -> MultiProjectDashboardState:
    from devflow.legacy.control_room.project_registry import load_registry, registry_path
