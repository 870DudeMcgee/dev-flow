...
def goal_init(
    ...
    from devflow.legacy.control_room.goals import create_goal_from_markdown
...
def goal_show(goal_id: str) -> None:
    ...
    from devflow.legacy.control_room.goals import render_goal_summary
...
def goal_list() -> None:
    """List durable goals."""
    from devflow.legacy.control_room.goal_projection import render_goal_list

    typer.echo(render_goal_list(Path.cwd()), nl=False)


def _set_goal_lifecycle_command(goal_id: str, lifecycle: str, reason: str) -> None:
    from devflow.legacy.control_room.goal_lifecycle import (
        GoalLifecycleError,
        lifecycle_result,
...
def goal_status(goal_id: str) -> None:
    ...
    from devflow.legacy.control_room.goal_projection import render_goal_status
...
def goal_slices(goal_id: str) -> None:
    ...
    from devflow.legacy.control_room.goal_tasks import render_goal_slices
...
def goal_create_task(
    ...
    from devflow.legacy.control_room.goal_tasks import get_goal_task_slice, create_task_from_goal_slice
