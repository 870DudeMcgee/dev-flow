...
def build_agent_catalog(root: Path, *, provider_id: str | None = None) -> dict[str, Any]:
    from devflow.control_room.agent_catalog import build_agent_catalog as _build_agent_catalog

    return _build_agent_catalog(root, provider_id=provider_id)


def configured_hermes_agents() -> list[dict[str, Any]]:
    from devflow.control_room.agent_catalog import configured_hermes_agents as _configured_hermes_agents
