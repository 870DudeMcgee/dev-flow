...
3. Inspect only the smallest relevant implementation files.
4. Preserve useful code that supports the control-room MVP.
5. Bypass old workflow machinery that conflicts with the MVP.
6. Keep changes focused and verify them.
