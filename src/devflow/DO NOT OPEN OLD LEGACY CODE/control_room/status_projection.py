...
from devflow.legacy.control_room.qwopus_evidence import qwopus_suggested_next_action
...
from devflow.legacy.control_room.task_next_gate import (
...
def _manual_evidence(root: Path, record: TaskRecord):
    if record.worker != "devflow-manual-codex-worker":
        return None
    from devflow.legacy.control_room.manual_worker import read_manual_agent_evidence
