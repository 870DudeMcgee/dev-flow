...
from devflow.legacy.control_room.agent_catalog_command import (
    AgentCatalogCommandError,
    build_agent_catalog_command_payload,
    render_agent_catalog_json,
    render_agent_catalog_lines,
)
from devflow.legacy.control_room.agent_registry import AgentRegistryError, load_agent_registry
from devflow.legacy.control_room.agent_runtime import agent_runtime_contract
from devflow.legacy.control_room.agent_workflow_receipts import (
    parse_read_next,
    write_agent_preflight_receipt,
    write_agent_scout_packet,
)
from devflow.legacy.control_room.scout_discovery import discover_agent_scout_context
...
def agent_add_provider(
    ...
    from devflow.legacy.control_room.agent_onboarding import AgentOnboardingError, add_provider
...
def agent_add_model(
    ...
    from devflow.legacy.control_room.agent_onboarding import AgentOnboardingError, add_model
...
def agent_list(
    ...
    if json_output:
        from devflow.legacy.control_room.local_model_worker_pool import registry_json_payload
...
def agent_show(
    ...
    if json_output:
        from devflow.legacy.control_room.local_model_worker_pool import agent_json_payload
...
def agent_policy(
    ...
    from devflow.legacy.control_room.local_model_worker_pool import agent_policy_payload
...
def agent_serial_packet(
    ...
    from devflow.legacy.control_room.serial_local_agent_run import (
...
def agent_hermes_run(
    ...
    from devflow.legacy.control_room.hermes_worker_runtime import (
...
def agent_context_pack(
    ...
    root = scope.root
    try:
        from devflow.legacy.control_room.context_pack import write_context_pack
...
def agent_evidence(
    ...
    root = Path.cwd()
    try:
        from devflow.legacy.control_room.agent_evidence import summarize_agent_evidence
...
def agent_verify(
    ...
    from devflow.legacy.control_room.agent_workflow_receipts import scout_packet_path, evidence_dir
...
def agent_discover_local(
    ...
    try:
        from devflow.legacy.control_room.local_agent_discovery import discover_local_ollama_models
...
def agent_select_local(
    ...
    root = scope.root
    try:
        from devflow.legacy.control_room.local_agent_discovery import (
...
def agent_audition(
    ...
    from devflow.legacy.control_room.model_audition import (
        ModelAuditionError,
...
def agent_hyperplane(
    ...
    from devflow.legacy.control_room.hyperplane_harness import (
...
def agent_hyperplane_list(
    ...
    from devflow.legacy.control_room.hyperplane_harness import list_hyperplane_runs
...
def agent_hyperplane_show(
    ...
    from devflow.legacy.control_room.hyperplane_harness import HyperplaneHarnessError, show_hyperplane_run
...
def agent_advise(
    ...
    from devflow.legacy.control_room.openrouter_agent import (
...
def agent_propose_patch(
    ...
    from devflow.legacy.control_room.openrouter_agent import OpenRouterAgentError, run_patch_proposal
...
def agent_run(
    ...
    if task_id is not None or profile_id is not None:
        from devflow.legacy.control_room.local_model_worker_pool import (
