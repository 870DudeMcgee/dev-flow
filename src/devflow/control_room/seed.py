...
""",
    ".devflow/layers/implementation/current-slice.md": f"# Current Slice\n\n{IMPLEMENTATION_CURRENT_SLICE_CONTEXT_MARKER}\n\nKeep the shell-worker MVP stable while building the read-only local operating-layer projection over existing control-room evidence. No provider-backed adapter, routing engine, database, or autonomous dashboard mutation surface is active in this slice.\n",
