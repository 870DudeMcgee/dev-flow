...
- [docs/architecture/agent-selection-and-context-routing.md](docs/architecture/agent-selection-and-context-routing.md): Milestone 17 evidence-only task-fit, context-estimation, scout, route, and routing-quality design; autonomous routing and provider-backed execution remain excluded.
