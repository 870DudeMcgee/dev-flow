...
from devflow.legacy.control_room.operating_layer_architecture_evidence_styles import ARCHITECTURE_EVIDENCE_CSS
from devflow.legacy.control_room.operating_layer_idea_greenhouse_styles import IDEA_GREENHOUSE_CSS
from devflow.legacy.control_room.operating_layer_obsidian_intake_styles import OBSIDIAN_INTAKE_CSS
from devflow.legacy.control_room.operating_layer_workbench_styles import WORKBENCH_CSS
from devflow.legacy.control_room.operating_layer_model_picker_styles import (
    BUILDER_JUDGE_MODEL_PICKER_CSS,
    MODEL_PICKER_CSS,
)
from devflow.legacy.control_room.operating_layer_task_control_styles import TASK_CONTROL_WORKBENCH_CSS
